...
export class TrainingsController {
    ...
    create(@Request() req, @Body() createTrainingDto: CreateTrainingDto, @UploadedFile() file?: Express.Multer.File) {
        return this.trainingsService.create(req.user.clubId, req.user.userId, createTrainingDto, file);
    }
    ...
    @Roles(UserRole.CLUB_ADMIN, UserRole.COACH)
    @UseInterceptors(FileInterceptor('file'))
    update(@Request() req, @Param('id') id: string, @Body() updateTrainingDto: any, @UploadedFile() file?: Express.Multer.File) {
